    ...
    return (
        <>
            <div className="nav-annotation">
                <CardTitle title="Two clicks to edit name"
                    onDoubleClick={() => {
                        setModalUpdate(true);
                        setNewAnnotationName({ title: selectedAnnotation.title, id: selectedAnnotation.idAnnotation });
                    }}>{selectedAnnotation.title}</CardTitle>
